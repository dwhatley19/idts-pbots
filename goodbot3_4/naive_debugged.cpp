...
int Bot::hand_strength(vector<string> hand)
{
    ...
    if(hand.size() == 4) return hand_strength4(hand);
    ...
    if(hand.size() == 7) return hand_strength7(hand);
}

int Bot::hand_strength_discard(vector<string> hand)
{
    if(hand.size() == 2) return hand_strength2(hand);
    if(hand.size() == 4) return hand_strength4(hand);
    if(hand.size() == 5) return hand_strength5(hand, 0);
    if(hand.size() == 6) return hand_strength6(hand, 0);
    if(hand.size() == 7) return hand_strength7(hand);
}
